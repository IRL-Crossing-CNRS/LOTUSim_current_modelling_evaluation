...
- `reference_implementations/` — the two current models being compared,
  ...
  the notebooks' comparison isn't circular: an implementation shared between
  "the model under test" and "the model producing the reference" would
  conceal any difference between the two.
