...
namespace gaussmarkov
{
  ...
  protected:
    void PublishCurrentVelocity(long simTime);
  ...
  protected:
    int localSimStartTime = 0;      // Track simulation start time for each depth
    std::set<int> loggedTimes;  // To store times when data has been logged
  };
